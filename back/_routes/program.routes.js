...
class ProgramRouter {
	constructor(provider) {
		...
		provider.put('/programs/session/:sessionId/exercise', AuthenticationController.ensureAuthorized, AuthenticationController.mustBeCoach, ProgramController.addExercise);
	}
}
